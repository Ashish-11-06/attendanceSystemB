...
CSRF_TRUSTED_ORIGINS = [
    "https://sncf-api.prushal.com",
    "https://sncf.prushal.com",
]
...
MIDDLEWARE = [
    'management.middleware.SocketIOMonitorMiddleware',
...
EMAIL_HOST_PASSWORD = 'pnqhgteuanykydbj'  # ⚠️ Consider using env variable instead
